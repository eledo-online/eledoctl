...
![Text Box Configuration](/static/assets/img/product/template-editor/components/text-box-configuration.png)
...
![Text Box icon (TXT) in the top toolbar](/static/assets/img/product/template-editor/components/text-box-toolbar.png)
...
For a complete reference of all supported patterns, see [**Formatting Dates**](/documentation/guides/formatting-dates).
...
- Learn how expressions work → [Expressions](/documentation/guides/expressions)
- Learn how to format values → [Printing Text](/documentation/guides/printing-text)
